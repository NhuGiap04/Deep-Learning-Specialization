...
if __name__ == '__main__':
    ...
    path = '../Datasets/Styles/starrynight.jpg'
    # path = '../Datasets/Styles/flowercarrier.jpg'
    # path = '../Datasets/Styles/monalisa.jpg'
    # path = '../Datasets/Styles/lesdemoisellesdavignon.jpg'
