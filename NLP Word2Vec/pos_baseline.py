...
def get_data(split_sequences=False):
    if not os.path.exists('Datasets'):
        ...
        exit()
    elif not os.path.exists('Datasets/POS Data/train.txt'):
        print("train.txt is not in chunking/train.txt")
        print("Please check the comments to get the download link.")
        exit()
    elif not os.path.exists('Datasets/POS Data/test.txt'):
    ...
    currentX = []
    currentY = []
    for line in open('Datasets/POS Data/train.txt', encoding='utf-8'):
        line = line.rstrip()
        if line:
            r = line.split()
            word, tag, _ = r
    ...
    currentX = []
    currentY = []
    for line in open('Datasets/POS Data/test.txt', encoding='utf-8'):
        line = line.rstrip()
        if line:
            r = line.split()
            word, tag, _ = r
