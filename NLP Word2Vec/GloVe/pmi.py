...
# input files
files = glob('../Datasets/Wiki Data/enwiki-20180401-pages-articles1.xml-p10p30302-01.txt')
...
print("Vector type: ", type(W))
distances = pairwise_distances(np.asarray(vec).reshape(1, D), np.asarray(W), metric='cosine').reshape(V)
...
def analogy(pos1, neg1, pos2, neg2):
    ...
    p1 = W[word2idx[pos1]].flatten()
    n1 = W[word2idx[neg1]].flatten()
    p2 = W[word2idx[pos2]].flatten()
    n2 = W[word2idx[neg2]].flatten()
