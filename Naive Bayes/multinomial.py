# Implement MultinomialNB in scikit-learn
# create a class Multinomial and the method fit, predict, score just like in Scikit-learn
...
# Test the model
model = MultinomialNB(smoothing=1e-2)
